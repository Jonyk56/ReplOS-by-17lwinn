...
void Protected() {
    ...
    while (1) {
        ...
        if (Cmp(ch, "help") == 1) {
            Write("I can't do much for an OS.\nAnd I probably will never be able to do much.\nYou might as well exit now, all I can do is say this and clear the screen :(.\n", -1, 0x000F);
            continue;
        }
